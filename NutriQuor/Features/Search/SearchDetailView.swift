...
#Preview {
    NavigationStack {
        SearchDetailView(data: SearchDTO(
            id: "1",
            name: "Aspartame",
            code: "E951",
            image: "test",
            description: "Aspartame là chất tạo ngọt nhân tạo được sử dụng rộng rãi trong thực phẩm và đồ uống ăn kiêng.",
            effects: [
                HealthEffect(id: 1, title: "Có thể gây đau đầu với một số người"),
                HealthEffect(id: 2, title: "Không phù hợp với người mắc PKU")
            ],
            found_in: [
                FoodCategory(id: 1, name: "Nước ngọt diet"),
                FoodCategory(id: 2, name: "Kẹo cao su"),
                FoodCategory(id: 3, name: "Sữa chua ít đường"),
                FoodCategory(id: 4, name: "Bánh quy ăn kiêng")
            ],
            type: "Chất tạo ngọt"
        ))
    }
